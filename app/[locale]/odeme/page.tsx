...
export default function CheckoutPage() {
  ...
  // PayTR sonuç sayfasından dönüş (?payment=success/fail)
  useEffect(() => {
  ...
  // PayTR iframe postMessage (yedek dönüş kanalı)
  useEffect(() => {
  ...
  // ── PayTR henüz aktif değil: bilgilendirme ekranı ──────────────
  if (!PAYTR_ENABLED) {
    return (
            ...
            <Card className="border-0 shadow-xl">
              <CardContent className="p-8 sm:p-10 text-center">
                ...
                <a
                  ...
                  className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#128C7E] to-[#075E54] px-6 py-3.5 text-base font-bold text-white shadow-lg transition-all hover:scale-[1.02]"
                >
